        ...
        <div class="card-body mt-4">
            <form action="{{ route('admin.card.update',$card->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="note_ar" 
                            ...
                            name="note_ar"  
                            autocomplete="note_ar" value="{{ $card->note_ar }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <textarea id="instruction_en" 
                                  ...
                                  name="instruction_en" 
                                  autocomplete="instruction_en">{{ $card->instruction_en }}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-8">
                        <textarea id="instruction_ar" 
                                  ...
                                  name="instruction_ar" 
                                  autocomplete="instruction_ar">{{ $card->instruction_ar }}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input id="cover_image" 
                                ...
                                name="cover_image" value="{{ $card->cover_image }}"
                        ...
                        <img id="cover-image-thumb" class="img-fluid  mt-2 " src="{{ asset('images/'.$card->cover_image) }}" style="width:120px;height:160px;border-radius: .9rem;background-color: #b3acac;border: 1px solid #dddfeb;">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-2">
                        <input id="popular" type="checkbox" class="form-control" name="popular" value="1" {{$card->popular == 1 ? 'checked' : ''}}>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <table class="table table-bordered" id="dynamicAddRemove">
                        ...
                        @foreach ($card->CardTypes as $key => $cardType)
                        <tr>
                            <td>
                                <input type="text" name="addMoreInputFields[{{ $key }}][type]" placeholder="Enter name" class="form-control" required="" value="{{ $cardType->type }}"/>
                                <input type="hidden" name="addMoreInputFields[{{ $key }}][id]" value="{{ $cardType->id }}"/>
                            </td>
                            <td ><input type="number"  name="addMoreInputFields[{{ $key }}][price]" step="0.001" placeholder="Enter price" class="form-control" required="" value="{{ $cardType->price }}"/></td>
                            <td ><input type="number"  name="addMoreInputFields[{{ $key }}][merchant_price]" step="0.001" placeholder="Enter merchant price" class="form-control" required=""  value="{{ $cardType->merchant_price }}"/></td>
                            @if ($key == 0)
