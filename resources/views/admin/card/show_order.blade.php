            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <dl class="row">
                        ...
                        <dd class="col-sm-8">{{$order->cardType->card->title_en}}</dd>
                      
                        <dt class="col-sm-4">Type:</dt>
                        <dd class="col-sm-8">{{$order->cardType->type}}</dd>

                        <dt class="col-sm-4">Price:</dt>
                        <dd class="col-sm-8">{{$order->cardType->price}}$</dd>

                        <dt class="col-sm-4">Merchant Price:</dt>
                        <dd class="col-sm-8">{{$order->cardType->merchant_price}}$</dd>
                      </dl>
