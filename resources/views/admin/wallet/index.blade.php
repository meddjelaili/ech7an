                ...
                <tbody>
                    @foreach ($transactions as $row)
                        <tr>
                            ...
                            <td class="text-center" >
                                <a href="{{ route('admin.wallet.confirme', $row->id) }}" class="btn btn-success btn-sm mb-2" title="confirme">
                                    <i class="fas fa-plus-circle"></i>
                                </a>
                                <a href="{{ route('admin.wallet.unconfirme', $row->id) }}" class="btn btn-danger btn-sm mb-2" title="rejected">
                                    <i class="fas fa-plus-circle"></i>
                                </a>
                            </td>
                        </tr>
